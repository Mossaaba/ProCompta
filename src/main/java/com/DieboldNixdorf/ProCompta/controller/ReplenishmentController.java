...
public class ReplenishmentController {
    ...
    public String GoReplenishment(Model model , @ModelAttribute Replenishment replenishment , final RedirectAttributes redirectAttributes) 
	{
	...
	@RequestMapping(value = "/replenishment/find", method = RequestMethod.POST)
