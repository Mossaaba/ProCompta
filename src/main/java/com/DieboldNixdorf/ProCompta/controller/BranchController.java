...
public class BranchController {
	...
	public String saveBranch(ModelMap model, @ModelAttribute("branch") Branch branch,
		...
		redirectAttrs.addFlashAttribute("msgTraitment", "Adding a new Branch : ");
		redirectAttrs.addFlashAttribute("theBranche", branch.getCodeBranche());
	...
	public String editBranchforSavig(ModelMap model, @ModelAttribute("branch") Branch branch,
		...
		redirectAttrs.addFlashAttribute("msgTraitment", "Updating the branche : ");
		redirectAttrs.addFlashAttribute("theBranche", branch.getCodeBranche());
		redirectAttrs.addFlashAttribute("style", "success");
		branchService.saveBranch(branch);
		return "redirect:/branch/list";
	...
	public String DeleteBranch(@PathVariable int idBranch, final RedirectAttributes redirectAttrs) {
