			                         ...
			                         <div class="row bg-white">
											...
											<div class="col-md-12">
														...
														<div class="card-body">
																...
																<form:form  modelAttribute="branch" method="POST" id="addbranchForm" autocomplete="off">
																...
																<div class="form-group-attached">
																	...
																	<label>Code Branche</label>
																	<form:input path="codeBranche" type="text" cssClass="form-control"  />
																	</div>
																		
																	<div class="row clearfix">
																		<div class="col-md-12">
																		<div class="form-group form-group-default required">
																		<label>Name Branche</label>
																		<form:input path="nomBranch" type="text" cssClass="form-control"  />
																		</div>
																		</div>
																...
																<div class="form-group-attached">
																	...
																	<label>Adress Branche <i class="fa fa-map text-complete m-l-5"></i>
																	</label>
																	<form:input path="adressBranch"  type="text" cssClass="form-control" />
																	</div>
																...
																<div class="row clearfix">
																	...
																	<div class="col-md-6">
																	<div class="form-group form-group-default required">
																	<label>Telephone Branche</label>
																	<form:input path="phoneBranch" type="text" cssClass="form-control" />
																	</div>
															        </div>
																	...
																	<form:input path="nbrStation" type="text" cssClass="form-control usd"  />
																	</div>
																	<div class="input-group-append ">
																	<span class="input-group-text">Nbr
																	</span>
																	</div>
																	</div>
																	</div>
						                                ...
						                                <form:button type="submit" id="addidBranchSuBmit" class="btn btn-primary  btn-cons"><i class="fa fa-plus-circle"></i> Update</form:button>
													    <form:button type="button" class="btn btn-cons btn-danger"><i class="fa fa-times-circle" ></i> Clear</form:button>	
													    					                                
						                                </c:when>
						                                <c:otherwise>
						                              <form:button type="submit"  id="addidBranchSuBmit" class="btn btn-primary  btn-cons"><i class="fa fa-plus-circle"></i> Add</form:button>
													  <form:button type="button" class="btn btn-cons btn-danger"><i class="fa fa-times-circle" ></i> Clear</form:button>
						                                </c:otherwise> 
										...
										<div class="row">
										 <div class="card card-transparent">
											<div class="card-body">
											   ...
											   <ol class="breadcrumb">
							                       <li class="breadcrumb-item"><a href="#">Home</a></li>
							                       <li class="breadcrumb-item active">Liste Branch</li>
							                     </ol>
							                   <div class="row bg-white">
										...
										<div class="col-md-12">
											...
											<div class="card card-transparent">
												...
												<div class="card-title">Branch
												</div>
												</div>
												
												<div class="card-body">
												 
												 <table class="table table-hover table-responsive-block nowrap " id="tableBranch">
										 <thead>
										 <tr>
										 
										  
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-address-card-o" aria-hidden="true"></i>Code Branche</th>
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-id-badge" aria-hidden="true"></i>Nom Branch</th>
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-id-badge" aria-hidden="true"></i>Adresse Branch </th>
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-id-badge" aria-hidden="true"></i>Nbr Station </th>
										 ...
										 <c:url var ="updateLink" value="/branch/edit-branch-${branch.idBranch}"></c:url>
										 <c:url var ="deleteLink" value="/branch/delete-branch-${branch.idBranch}"></c:url>
										 
										 
										  <tr>
											 
											 <td class="text-primary font-montserrat v-align-middle password">${branch.codeBranche}</td>
											 <td class="text-primary font-montserrat v-align-middle">${branch.nomBranch}</td>
											 <td class="text-primary font-montserrat v-align-middle">${branch.adressBranch}</td>
											 <td class="text-primary font-montserrat v-align-middle">${branch.nbrStation}</td>
