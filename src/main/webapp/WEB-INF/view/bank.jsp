			                     ...
			                     <div class=" container-fluid   container-fixed-lg ">
			                         ...
			                         <div class="row bg-white">
											...
											<div class="card card-transparent">
												...
												<div class="card-title">Bank
												</div>
												</div>
												
												<div class="card-body">
												 
												 <table class="table table-hover table-responsive-block nowrap " id="tableBank">
										 <thead>
										 <tr>
										 
										  
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-address-card-o" aria-hidden="true"></i>Name</th>
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-id-badge" aria-hidden="true"></i>Logo</th>
										 <th class="v-align-middle text-primary bold fs-10"><i class="fa fa-id-badge" aria-hidden="true"></i>Bin </th>
										 ...
										 <c:url var ="updateLink" value="/bank/edit-bank-${bank.idBank}"></c:url>
										 <c:url var ="deleteLink" value="/bank/delete-bank-${bank.idBank}"></c:url>
										 
										 
										  <tr>
											 
											 <td class="text-primary font-montserrat v-align-middle password">${bank.abbreviation}</td>
											 <td class="text-primary font-montserrat v-align-middle">${bank.logo}</td>
										  ...
										  <security:authorize access="hasRole('ADMIN')">
											...
											<div class="col-md-7">
														...
														<div class="card-body">
																...
																<form:form  modelAttribute="bank" method="POST" id="addBankForm" autocomplete="off">
																...
																<div class="form-group-attached">
																	...
																	<form:input path="namBank" type="text" cssClass="form-control"  />
																	</div>
																	...
																	<div class="row clearfix">
																		...
																		<form:input path="abbreviation" type="text" cssClass="form-control"  />
																		</div>
																		</div>
																	...
																	<div class="col-md-6">
																		...
																		<label>Logo</label>
																		<form:input path="logo" type="text" cssClass="form-control"  />
																		</div>
																	</div>
																	</div>
																...
																<div class="form-group-attached">
																	...
																	<div class="form-group form-group-default">
																	<label>Adress <i class="fa fa-map text-complete m-l-5"></i>
																	</label>
																	<form:input path="adressBank"  type="text" cssClass="form-control" />
																	</div>
																...
																<div class="row clearfix">
																	...
																	<form:input path="phoneBank" type="text" cssClass="form-control" />
																	</div>
															        </div>
																	...
																	<form:input path="bin" type="text" cssClass="form-control usd"  />
																	</div>
																	<div class="input-group-append ">
																	<span class="input-group-text">BIN
																	</span>
																	</div>
																	</div>
																	</div>
						                                ...
						                                <form:button type="submit" id="addBankSumit" class="btn btn-primary  btn-cons"><i class="fa fa-plus-circle"></i> Update</form:button>
													    <form:button type="button" class="btn btn-cons btn-danger"><i class="fa fa-times-circle" ></i> Clear</form:button>	
													    					                                
						                                </c:when>
						                                <c:otherwise>
						                              <form:button type="submit"  id="addBankSumit" class="btn btn-primary  btn-cons"><i class="fa fa-plus-circle"></i> Add</form:button>
													  <form:button type="button" class="btn btn-cons btn-danger"><i class="fa fa-times-circle" ></i> Clear</form:button>
						                                </c:otherwise> 
