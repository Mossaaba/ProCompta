							...
							<div class="col-lg-6">
								<div id="card-linear" class="card card-default">
									<div class="card-header  ">
										<div class="card-title">Portlet Title</div>
														...
														<div class="col-md-3">
															<div class="form-group form-group-default input-group">
																<div class="form-input-group">
																	<label class="inline">utiliser le régulateur
																		prix</label>
																</div>
												...
												<div class="form-group-attached">
													...
													<div class="row clearfix">
														<div class="col-md-6">
															<div class="form-group form-group-default input-group">
																<div class="form-input-group">
																	<label>Numero authorisation</label>
							...
							<c:if test="${!empty msg }">
								<div class="col-lg-6">
									<div class="card card-default bg-${css}" data-pages="card">
										<div class="card-header ">
											<div class="card-title">Draggable Portlet</div>
											<div class="card-controls">
												<ul>
													<li><a href="#" class="card-collapse"
														data-toggle="collapse"><i
										...
										<div class="card-body">
											<h3 class="text-white">
												<span class="semi-bold">Notification</span> SVP!
											</h3>
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="card card-transparent">
										<div class="card-header ">
											<div class="card-title">Resultat de recherche</div>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-lg-12">
															...
															<div id="card-advance" class="card card-default">
																<div class="card-header  ">
																	<div class="card-title">
																	 ...
																	 <div class="export-options-container2 pull-right"></div>
																	<div class="card-controls">
																		<ul>
																			<li>
																				<div class="dropdown">
																...
																<div class="card-body">
																	...
																	<table
																		class="table table-hover demo-table-search table-responsive-block  nowrap"
																		id="tableWithSearch">
																		<thead>
																			<tr>
																				<th></th>
																		...
																		<tbody>
																			...
																			<c:forEach items="${ListTransactionAfterFiltring}"
																				...
																				<tr>
																					...
																					<td class="v-align-middle">${transaction.nauthorisation}
																					</td>
																					<td class="v-align-middle">${transaction.remarque}
																					</td>
...
$(function() {
	...
	var initTableWithSearch = function() {
        ...
        var settings = {
            "sDom": "<'exportOptions2'T><'table-responsive't><'row'<p i>>", //  '.exportOptions2' will hold all the export buttons
            ...
            fnDrawCallback: function(oSettings) {
                ...
                $('#ToolTables_historyDataTable_0').tooltip({ // Change these IDs to match XXXXX IDs that dataTAbles plugin has generated for each button
                    title: 'Export as CSV',
                    container: 'body'
                });

                $('#ToolTables_historyDataTable_1').tooltip({
                    title: 'Export as Excel',
                    container: 'body'
                });

                $('#ToolTables_historyDataTable_2').tooltip({
                    title: 'Export as PDF',
                    container: 'body'
                });

                $('#ToolTables_historyDataTable_3').tooltip({
                    title: 'Copy data',
                    container: 'body'
                });
            }
